...
def plot_3d_motion_music(save_path,audio_path, kinematic_tree, joints, title, figsize=(10, 10), fps=120, radius=4):
    matplotlib.use('Agg')
    ...
    tmp_mp4_path = '/mnt/bn/HumanTOMATO/tmp.mp4'
    ani.save(tmp_mp4_path, writer='ffmpeg', fps=fps)

    import os
    out = os.system(
            f"ffmpeg -loglevel error -stream_loop 0 -y -i {tmp_mp4_path} -i {audio_path} -r {fps} -c:v libx264 -crf 18 -c:a aac -q:a 2 {save_path}"
        )
    
    # # 使用 moviepy 添加 WAV 音频
...
if __name__ == '__main__':
    ...
    example_path = '/mnt/bn/HumanTOMATO/datasets/souldance_data/motion_623/40360_45779_slice180.npy'
    ...
    xyz = global_postion.reshape(-1, 52, 3)

    # feel free to change the output name
    # pose_vis = draw_to_batch_smplh(xyz, t2m_body_hand_kinematic_chain, title_batch=None, outname=[f'/mnt/bn/HumanTOMATO/output_2.gif'])

    save_path = '/mnt/bn/HumanTOMATO/plot.mp4'
    audio_path = '/mnt/bn/HumanTOMATO/datasets/souldance_data/music/40360_45779_slice180.wav'
    plot_3d_motion_music(save_path,audio_path, t2m_body_hand_kinematic_chain, xyz, title='40360_45779_slice180', fps=60)
    print('done!')
