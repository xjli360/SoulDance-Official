...
HUMAN_MODEL_PATH = '/workspace/HumanTOMATO/src/tomato_represenation/body_models'
...
if __name__ == '__main__':
    ...
    device = 'cuda:0'
    example_data = np.zeros((100, 322)) 
    data = torch.tensor(example_data).unsqueeze(0).to(device)
    ...
    mesh.export('/mnt/bn/HumanTOMATO/test.obj')
